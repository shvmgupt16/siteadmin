		...
		public function addRecord()
		{
			 $filename='';
			  if (is_uploaded_file($_FILES['image']['tmp_name']))
					...
					$r = uniqid();					
					$filename= $r.'_'.$image;
					move_uploaded_file($_FILES['image']['tmp_name'], "../admin/images/gallery/".$filename);	
					}
			  
			  
$q = "insert into ".$this->_table." (portfolio,description,image,status) values ('".$_POST['portfolio']."','".addslashes($_POST['description'])."','".$filename."','Y')";	
			if(mysql_query($q))
			{
		...
		public function updateRecord()
		{
			...
			$q = "update ".$this->_table." set portfolio= '".$_POST['portfolio']."',image='".$filename."',description = '".addslashes($_POST['description'])."',status='Y' where id=".$_POST['id'];
			if(mysql_query($q))
			{
