...
$q = "insert into ".$this->_table." (name,designation,image,status) values ('".$_POST['name']."','".$_POST['designation']."','".$filename."','Y')";	
			if(mysql_query($q))
			{
		...
		public function updateRecord()
		{
			...
			$q = "update ".$this->_table." set name= '".$_POST['name']."',image='".$filename."',designation ='".$_POST['designation']."', ,status='Y' where id=".$_POST['id'];
			if(mysql_query($q))
			{
