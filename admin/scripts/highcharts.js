...
(function () {
                ...
                n(m, function (e) {
                    if (e !== "" || m.length === 1) {
                        ...
                        if (e !== " " && (n.appendChild(z.createTextNode(e)), p ? o.dx = 0 : o.x = i, w(n, o), !p && f && (!Z && d && L(n, {
                            display: "block"
                        }), w(n, "dy", l || c.fontMetrics(/px$/.test(n.style.fontSize) ? n.style.fontSize : j.fontSize).h, fb && n.offsetHeight)), b.appendChild(n), p++, k)) for (var e = e.replace(/([^\^])-/g, "$1- ").split(" "), t, u = []; e.length || u.length;) delete a.bBox, t = a.getBBox().width, o = t > k, !o || e.length === 1 ? (e = u, u = [], e.length && (n = z.createElementNS(xa, "tspan"), w(n, {
                            dy: l || 16,
                            x: i
    ...
    La.prototype = {
        ...
        render: function (a, b, c) {
            ...
            if (i && !isNaN(I)) i.xy = G = this.getLabelPosition(I, G, i, g, k, E, a, s), this.isFirst && !this.isLast && !p(e.showFirstLabel, 1) || this.isLast && !this.isFirst && !p(e.showLastLabel, 1) ? w = !1 : !x && g && k.overflow === "justify" && !this.handleOverflow(a, G) && (w = !1), s && a % s && (w = !1), w && !isNaN(G.y) ? (G.opacity = c, i[this.isNew ? "attr" : "animate"](G), this.isNew = !1) : i.attr("y", -9999)
        },
        destroy: function () {
            Ja(this, this.axis)
        }
    ...
    db.prototype = {
        ...
        setTickPositions: function (a) {
            ...
            if (!a)(b.max - b.min) / b.tickInterval > 2 * b.len && ja(19, !0), a = f ? (b.getNonLinearTimeTicks || Eb)(Cb(b.tickInterval, d.units), b.min, b.max, d.startOfWeek, b.ordinalPositions, b.closestPointRange, !0) : e ? b.getLogTickPositions(b.tickInterval, b.min, b.max) : b.getLinearTickPositions(b.tickInterval, b.min, b.max), b.tickPositions = a;
    ...
    wb.prototype = {
        init: function (a, b) {
            var c = this,
                ...
                f = b.itemMarginTop || 0;
            this.options = b;
            if (b.enabled) c.baseline = A(d.fontSize) + 3 + f, c.itemStyle = d, c.itemHiddenStyle = x(d, b.itemHiddenStyle), c.itemMarginTop = f, c.padding = e, c.initialItemX = e, c.initialItemY = e - 5, c.maxItemWidth = 0, c.chart = a, c.itemHeight = 0, c.lastLineHeight = 0, c.render(), J(c.chart, "endResize", function () {
    ...
    Q.prototype = {
        ...
        setData: function (a, b) {
            ...
            if (i && m > i) {
                ...
                if (qa(f)) {
                    ...
                    this.xIncrement = f
                } else if (Ha(f)) if (o) for (i = 0; i < m; i++) d = a[i], j[i] = d[0], k[i] = d.slice(1, o + 1);
        ...
        translate: function () {
            ...
            for (var a = this.options, b = a.stacking, c = this.xAxis, d = c.categories, e = this.yAxis, f = this.points, g = f.length, h = !! this.modifyValue, i = a.pointPlacement, j = i === "between" || qa(i), k = a.threshold, a = 0; a < g; a++) {
                ...
                if (b && this.visible && n && n[m]) n = n[m], r = n.total, n.cum = q = n.cum - o, o = q + o, n.cum === 0 && (q = p(k, e.min)), e.isLog && q <= 0 && (q = null), b === "percent" && (q = r ? q * 100 / r : 0, o = r ? o * 100 / r : 0), l.percentage = r ? l.y * 100 / r : 0, l.total = l.stackTotal = r, l.stackY = o, n.setOffset(this.pointXOffset || 0, this.barW || 0);
            ...
            if (a.visible && (e.enabled || a._hasPointLabels)) {
                ...
                for (I = 2; I--;) {
                    ...
                    for (B = 0; B < J; B++) {
                        ...
                        s.connX = z;
                        s.connY = E;
                        if (this.options.size === null) w = s.width, z - w < f ? C[3] = r(u(w - z + f), C[3]) : z + w > h - f && (C[1] = r(u(z + w - h + f), C[1])), E - x / 2 < 0 ? C[0] = r(u(-E + x / 2), C[0]) : E + x / 2 > d && (C[2] = r(u(E + x / 2 - d), C[2]))
                    }
                }
