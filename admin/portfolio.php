...
require_once('../classes/testimonials.class_portfolio.php');
...
?>
    ...
    <div class="content">     
        <div class="header">
            <h1 class="page-title">Manage Portfolio </h1>
        </div>      
                <ul class="breadcrumb">
...
if($resource->_view == 'list')
{ ?>
<a href="<?php echo $_SERVER['PHP_SELF'].'?view=add';?>" class="btn btn-primary">Add Portfolio</a>	<br/>
<?php 
...
?>      
        <tr class="<?php echo $rowClass; ?>">
          <td><?php echo $i; ?></td>
          <td><?php echo $res['portfolio']; ?></td>  
          
          <td><?php echo stripslashes($res['description']); ?></td>
          <td><img width="80" height="60" src="<?php echo '../admin/images/gallery/'.$res['image']; ?>" /></td>
...
?>
 <form name="add-Portfolio" action="<?php echo $_SERVER['PHP_SELF'];?>" method="post" enctype="multipart/form-data">
<table class="form " >
...
<tr>
    ...
    <td>
	<input type="text" name="portfolio" id="name" value="<?php echo $res['portfolio'];?>" style="width:415px;"/>
    <div id="portfolio_error" style="color:red"></div>
    </td>
</tr>
<tr>
	<td>
...
<tr>
    ...
    <?php if($res['image']!='') { ?><img src="<?php echo '../admin/images/gallery/'.$res['image'];?>" width="70" height="60" /> <?php } ?>
...
//===================Form Validation=======================
  ...
  function validForm() { 
	  ...
	  //var news=document.getElementById("news").value;
	   ...
	   if(portfolio== '') {
	     document.getElementById("portfolio_error").innerHTML="Enter Portfolio";
	     document.getElementById("name").style.borderColor='red';
		 cnt++;
	   }
	   else 
	   {
	     document.getElementById("portfolio_error").innerHTML="";
