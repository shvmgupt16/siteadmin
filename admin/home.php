...
require_once('../classes/testimonials.class_home.php');
...
?>
    ...
    <div class="content">     
        <div class="header">
            <h1 class="page-title">Manage Homepage </h1>
        </div>      
                <ul class="breadcrumb">
...
?>
 <form name="edit-homepage action="<?php echo $_SERVER['PHP_SELF'];?>" method="post" enctype="multipart/form-data">
<table class="form " >
...
<tr>
    ...
    <td>
	<input type="text" name="heading" id="heading value="<?php echo $res['portfolio'];?>" style="width:415px;"/>
...
<tr>
    ...
    <td>
	<textarea name="description"  id="description" style="margin: 0px 0px 9px; height: 80px; width: 398px;"> <?php echo stripslashes($res['descrption']);?></textarea>
...
//===================Form Validation=======================
  ...
  function validForm() { 
      var cnt=0;
	  var portfolio=document.getElementById("heading").value;
	  var description=document.getElementById("description").value;
	  //var news=document.getElementById("news").value;

	   if(portfolio== '') {
	     document.getElementById("heading_error").innerHTML="Enter Portfolio";
	     document.getElementById("heading_error").style.borderColor='red';
		 cnt++;
	   }
	   else 
	   {
	   ...
	   if(description == '') {
	     ...
	     document.getElementById("description_error").style.borderColor='red';
		 cnt++;
	   }
	   else 
	   {
